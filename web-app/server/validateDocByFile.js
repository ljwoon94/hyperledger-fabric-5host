...
const caCertPath = path.resolve(__dirname, '..', '..', 'fabric-sample', 'raft-5node-swarm', 'crypto-config', 'peerOrganizations', 'org1.example.com', 'ca', 'ca.org1.example.com-cert.pem');
